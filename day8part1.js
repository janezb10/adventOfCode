let input = `dfgabce cadfgb cefa ca aecbg dfcegb geabd ecbfg cab agcfbe | egbfadc dbgae gcfeb abgdfc
...
for(i=0;i<input.length;i++){
  for(l=0;l<input[i][1].length;l++){
    if(arr.includes(input[i][1][l].length)) result++;
    console.log(input[i][1][l]);
  }
}
